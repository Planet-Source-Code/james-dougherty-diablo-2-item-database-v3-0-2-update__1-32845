...
Begin VB.Form frmJewels 
   BorderStyle     =   0  'None
   ClientHeight    =   2235
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5235
   Icon            =   "frmJewels.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmJewels.frx":000C
   ScaleHeight     =   149
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   349
   ...
   Begin VB.CommandButton cmdClose2 
      DownPicture     =   "frmJewels.frx":1676
      Height          =   210
      Left            =   4800
      Picture         =   "frmJewels.frx":19DA
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   240
      Width           =   210
   ...
   Begin prjChameleon.chameleonButton cmdFunc 
      ...
      FCOLO           =   0
      MPTR            =   0
      MICON           =   "frmJewels.frx":1CED
   End
   Begin VB.Label lblStatus 
      BackColor       =   &H00000000&
      Caption         =   " Add Rune, Jewel, And/Or Gem"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
...
Select Case Index
 Case 0
  If txtName.Text = "" Then
   frmMSG.lblMessage.Caption = "Please enter a name for the jewel."
   frmMSG.Show 1
   Exit Sub
  End If
...
FloatWindow frmJewels.hWnd, Float
End Sub
...
FloatWindow frmJewels.hWnd, SINK
End Sub
