...
Begin VB.Form frmJewelry 
   BorderStyle     =   0  'None
   ClientHeight    =   3855
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6210
   Icon            =   "frmJewelry.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmJewelry.frx":000C
   ScaleHeight     =   257
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   414
   ...
   Begin VB.CommandButton cmdClose2 
      DownPicture     =   "frmJewelry.frx":2DC0
      Height          =   210
      Left            =   5760
      Picture         =   "frmJewelry.frx":3124
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   360
      Width           =   210
   ...
   Begin VB.Image imgChar 
      Height          =   480
      Left            =   315
      Picture         =   "frmJewelry.frx":53CA
      Top             =   360
      Width           =   480
   End
End
Attribute VB_Name = "frmJewelry"
...
Select Case Index
 Case 0
  ...
  If txtName.Text = "" Then
   frmMSG.lblMessage.Caption = "Please enter a name for the jewelry."
   frmMSG.Show 1
   Exit Sub
  End If
  
  If lblTemp.Caption = "" Then
   frmMSG.lblMessage.Caption = "Please select the type of jewelry."
   frmMSG.Show 1
   Exit Sub
  End If
...
FloatWindow frmJewelry.hWnd, Float
End Sub
...
FloatWindow frmJewelry.hWnd, SINK
End Sub
