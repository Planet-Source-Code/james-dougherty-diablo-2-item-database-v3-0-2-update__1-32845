...
Begin VB.Form frmCharm 
   BorderStyle     =   0  'None
   ClientHeight    =   2235
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5250
   Icon            =   "frmCharm.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmCharm.frx":000C
   ScaleHeight     =   149
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   350
   ...
   Begin VB.CommandButton cmdClose2 
      DownPicture     =   "frmCharm.frx":1676
      Height          =   210
      Left            =   4800
      Picture         =   "frmCharm.frx":19DA
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   240
      Width           =   210
...
Select Case Index
 Case 0
  If txtName.Text = "" Then
   frmMSG.lblMessage.Caption = "Please enter a name for the charm."
   frmMSG.Show 1
   Exit Sub
  End If
  CharmName = txtName.Text
  CharmOK = True
  Unload Me
 Case 1
  CharmOK = False
...
FloatWindow frmCharm.hWnd, Float
End Sub
...
FloatWindow frmCharm.hWnd, SINK
End Sub
