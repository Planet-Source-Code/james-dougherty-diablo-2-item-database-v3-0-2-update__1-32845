...
Begin VB.Form frmChar 
   ...
   Begin VB.CommandButton cmdClose2 
      DownPicture     =   "frmChar.frx":1676
      Height          =   210
      Left            =   4800
      Picture         =   "frmChar.frx":19DA
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   240
      Width           =   210
...
Select Case Index
 Case 0
  If txtName = "" Then
   frmMSG.lblMessage.Caption = "Please enter a new character's name."
   frmMSG.Show 1
   Exit Sub
  End If
...
FloatWindow frmChar.hWnd, Float
End Sub
